...
- Flight has [SimplePdo](/learn/simple-pdo) for database access, which is a touch simpler than Fat-Free's built-in `DB\SQL` class (and preferred over the deprecated PdoWrapper).
