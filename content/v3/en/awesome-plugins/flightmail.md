...
Using the [Flight PHP skeleton](https://github.com/flightphp/skeleton)? Register in `app/config/services.php` with the instance style instead:
...
For bug reports, pull requests, and the full source, visit the [GitHub repository](https://github.com/ryanstubbs/flightmail).
